...
func (m *MockStakingHooks) AfterRedelegationSlashed(ctx context.Context, valAddr types1.ValAddress, delAddr types1.AccAddress, slashedAmount math.Int) error {
	m.ctrl.T.Helper()
...
func (m *MockStakingHooks) AfterUnbondingDelegationSlashed(ctx context.Context, valAddr types1.ValAddress, delAddr types1.AccAddress, slashedAmount math.Int) error {
	m.ctrl.T.Helper()
...
func (m *MockStakingHooks) CustomBeforeValidatorSlashed(ctx context.Context, valAddr types1.ValAddress, fraction math.LegacyDec, totalSlashedAmt math.Int) error {
	m.ctrl.T.Helper()
